...
scan-build -o myhtml -v --use-analyzer=/usr/lib/llvm-9/bin/clang -enable-checker optin.cplusplus.UninitializedObject -enable-checker alpha.unix.PthreadLock make
